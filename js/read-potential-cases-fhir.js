...
(async () => {
  ...
  await fs.writeFile("diverticular-disease-of-intestine-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diverticular-disease-of-intestine-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
